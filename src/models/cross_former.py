...
class Decoder(nn.Module):
    ...
    def forward(self, x, cross):
        ...
        for layer in self.decode_layers:
            ...
            i += 1
        # TODO: Stacking instead of adding
...
class Crossformer(nn.Module):
    """Current implementation learns on forecasting (unidirectional)
    # TODO: Look at bidirectional implementation
    # TODO: use MVTS masking strategy for imputation
